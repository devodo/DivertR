...
{
    internal class FuncCallHandler<TTarget, TReturn> : CallHandler<TTarget> where TTarget : class?
    {
    ...
    internal class FuncCallHandler<TTarget, TReturn, TArgs> : CallHandler<TTarget>
        where TTarget : class?
