...
namespace DivertR
{
    public interface IRedirectBuilder<TTarget> where TTarget : class
    {
        ...
        ISpyCollection<TMap> Spy<TMap>(Func<IRecordedCall<TTarget>, TMap> mapper, Action<IRedirectOptionsBuilder<TTarget>>? optionsAction = null);
        ISpyCollection<TMap> Spy<TMap>(Func<IRecordedCall<TTarget>, CallArguments, TMap> mapper, Action<IRedirectOptionsBuilder<TTarget>>? optionsAction = null);
    }
}
